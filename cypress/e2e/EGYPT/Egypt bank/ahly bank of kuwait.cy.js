describe('Payment Validation SA', () => {
    ...
    it('validates payment flow in SA', () => {
      ...
      cy.contains('Egypt')
        ...
        cy.wait(30000) 
        cy.contains('.card-content', 'Egypt Bank Wallets')
        .should('be.visible')
        .click(); 

        //Ahly Bank of Kuwait(Egypt Bank Wallet) 
        cy.wait(30000) 
        cy.contains('.card-content', 'Ahly Bank of Kuwait')
        .should('be.visible')
        .click(); 
...
//asserting user can proceed to pay with Ahly Bank of Kuwait
