describe('Payment Validation SA', () => {
    ...
    it('validates payment flow in SA', () => {
      ...
      cy.get('.countrySelectButton').type('Ghana'); // Type in the input
      ...
      cy.contains('Ghana')
        ...
        cy.get('[data-testid="save-settings"]').click();
          ...
          cy.get(':nth-child(1) > [data-sentry-component="GenericCarousel"] > .overflow-hidden > .gap-3 > [href="/en/GH/product/carry1st-trivia-1/direct-topup"] > .h-full > .w-full', { timeout: 50000 })
          .should('be.visible')
          .scrollIntoView()
          .click({ force: true });
        ...
        ;
          ...
          cy.get('.grid-cols-1 > :nth-child(1)', { timeout: 50000 })
            .scrollIntoView()
            .should('be.visible')
            .click();
          ...
          cy.wait(9000)
            cy.get('#cardNumber').type('5343208850185202', { force: true });
        
            // Focus on the expiry date field and type the value
            cy.get('#expiryDate')
              .scrollIntoView()
              .type('2512', { force: true });
        
        
              // Type CVV
            cy.get('#cvv').type('244', { force: true });
